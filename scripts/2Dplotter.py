...
x = 1                                                #Dont forget when choosing a file, the index begins at 0
file = file_arr[x]
x = x + 1                                            #For naming purposes in Multiple Plots against a single variable Plotter
h2 = ROOT.TH2F("h2", "h2 title", 24, 0, 600, 24, 0, 600)
...
var = 'm_2fatjet_kt8'                                                   #var is on the x axis
var2= 'm_1fatjet_kt8'                                                   #var2 is on the y axis

a = "sample_{}".format(x)
file.Draw(var+":"+var2+">>h2",total,"")
h2.Draw("colz")
h2.SetTitle(a)
h2.GetXaxis().SetTitle(var2)
h2.GetYaxis().SetTitle(var)
if var == 'm_2fatjet_kt8' and var2 == 'm_1fatjet_kt8':
...
#c.SaveAs(save_path+a+"_reco_"+var+"_"+var2+"_noSC.png")


                      #Multiple Plots against a single variable
'''
var2="mctTT"
list_of_vars = ["m_1fatjet_kt8","m_2fatjet_kt8"]
...
for var in list_of_vars:
  ...
  #save_path2 = '/home/jhall/SUSY/AnalysisWrapper/LocalAnalysis/plots/reco_fat_jet_study/SigVsBkg_Comp/updated_script_plots/2D_correlation/updated/'
  #c.SaveAs(save_path2+a+"_reco_"+var+"_"+var2+"_noSC.pdf")
'''
...
'''
TH2* h2 = new TH2F("h2", "h2 title", 100, 0, 1500, 100, 0, 1500)
NominalFixed->Draw("m_1fatjet_kt8:pT_1fatjet_kt8>>h2")
h2->Draw("colz")
'''
