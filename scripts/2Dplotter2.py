...
class Files:
  ...
  @classmethod
#  def Process_Files(cls, subfile):
#    for i in range(len(cls.subfile)):
#    cls.subfile = subfile
    pass
...
x = 4                                                #Dont forget when choosing a file, the index begins at 0
file = file_arr[x]
...
var = 'm_2fatjet_kt8'                                                   #var is on the y axis
var2="m_1fatjet_kt8"                                                   #var2 is on the x axis
